...
public:
    ...
    void add_metrics(const std::string& name)
    void update_metrics();
...
private:
    ...
    std::unordered_map<std::string, LockGauge> _wg_cpu_limit_metrics;
    std::unordered_map<std::string, LockGauge> _wg_cpu_metrics;
    std::unordered_map<std::string, AtomicGauge> _wg_mem_limit_metrics;
    std::unordered_map<std::string, AtomicGauge> _wg_mem_metrics;
};
